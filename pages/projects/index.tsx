      ...
      <div className="projects">
        <div className="checks-container">
          <div className="wrapped-view flex flex-row items-center justify-between max-sm:flex-col">
            <div className="hero-section-wrapper w-fit h-auto flex flex-col items-start justify-between pl-12 mb-16 max-sm:items-center max-sm:pl-0 max-sm:mb-8">
              <Callout className="small-callout max-sm:flex max-sm:flex-row max-sm:justify-evenly max-sm:w-[70%] max-sm:gap-0 max-sm:w-auto max-sm:h-auto">
              ...
              <h1 className="font-product-bungee text-5xl mt-4 leading-tight flex flex-col items-start justify-between max-sm:items-center max-sm:text-3xl max-sm:gap-1 max-sm:mt-6 ">
                <span className="w-[16ch] max-sm:text-center">
                  {"Projects built by Amazing HEKORS"}
                  <Image
              ...
              <div className="cta-buttons-layer-wrapper mt-12 flex flex-row justify-center gap-8 w-fit h-auto max-sm:flex-col max-sm:mt-8">
