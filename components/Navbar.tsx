    ...
    return (
        <div className="navbar py-6 flex flex-row items-center justify-between">
            <Link href="/" className="navbar-logo-wrapper flex flex-row items-center justify-start w-fit h-auto gap-3 cursor-pointer select-none">
                <Image src="/hekors-logo.png" alt="hekors-logo" className="rounded-lg" width="46" height="46" priority />
                {/* <span className="navbar-logo-title-wrapper text-gray-800 text-sm flex flex-col items-start justify-center font-semibold tracking-tighter">
                    <span className="navbar-logo-title-HEKORS-text-wrapper select-none">{"HEKORS"}</span>
