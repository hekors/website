...
async function getAllHackathons() {
    ...
    await axios.get(baseURL + '/api/hackathons').then((hackathonResponse: any) => {
...
async function getHackathon(_hackathonID: string) {
    await axios.get(baseURL + '/api/hackathons/' + _hackathonID).then((hackathonResponse: any) => {
...
async function getUpcomingHackathons() {
    ...
    await axios.get(baseURL + '/api/hackathons').then((hackathonResponse: any) => {
        ...
        hackathonResponse?.data?.data?.map(async (response: any) => {
            ...
            allHackathonsResponse = [await _hackathonData, ...allHackathonsResponse];
        });
    });
